...
const { forwardAuthenticated, ensurePartAuthenticated, forwardPartAuthenticated } = require('../config/auth')

// Load User model
const User = require('../models/User')

// Login Parts Page
router.get('/', forwardPartAuthenticated, (req, res) => 
...
router.get ('/partAdmin', ensurePartAuthenticated, (req, res) =>
    res.render('pages/partAdmin', {banner: 'Parts Admin', message:''})
)

//Route to Admin page to search by SAP part number
router.get ('/partAdminLV', ensurePartAuthenticated, (req, res) =>
...
// Login Parts
router.post('/partLogin', (req, res, next) => {
    passport.authenticate('local', {
        successRedirect: '/partLogin/partAdmin',
...
router.get('/userEdit', forwardAuthenticated, (req, res) => res.render('pages/userEdit', {banner: 'User Admin', message: ''}))
